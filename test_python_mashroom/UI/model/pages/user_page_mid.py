...
class UserPage:
    ...
    def send_message(self):
        browser.element(
            '/html/body/vue-widget/div/div[1]/main/div/div/div[2]/div/div/div[2]/div/div/div/div[2]/div/form/div/'
            'div/div/div/div/textarea').clear()
        browser.element(
            '/html/body/vue-widget/div/div[1]/main/div/div/div[2]/div/div/div[2]/div/div/div/div[2]/div/form/div/div/'
            'div/div/div/textarea').should(
